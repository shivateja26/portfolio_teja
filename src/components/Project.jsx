...
const Project = () => {
  const projects = [
    ...
    { title: "Project 3", description: "An innovative project with cutting-edge technology.", link: "#" },
    { title: "Project 4", description: "A creative solution to a common issue.", link: "#" },
    { title: "Project 5", description: "An e-commerce platform with unique features.", link: "#" },
    { title: "Project 6", description: "A mobile app that enhances user engagement.", link: "#" },
    { title: "Project 7", description: "A platform to connect people in new ways.", link: "#" },
    { title: "Project 8", description: "A service that simplifies everyday tasks.", link: "#" },
    { title: "Project 9", description: "A highly customizable web app for different use cases.", link: "#" },
    { title: "Project 10", description: "An educational platform for modern learners.", link: "#" }
  ];
