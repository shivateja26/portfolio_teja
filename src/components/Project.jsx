...
const Project = () => {
  const projects = [
    ...
    { title: "E-commerce", description: "A dynamic e-commerce platform offering a wide variety of gaming PCs, accessories, and other.", link: "https://github.com/shivateja26/ecommerce_project" },
