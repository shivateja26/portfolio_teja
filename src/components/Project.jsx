...
const Project = () => {
  const projects = [
    ...
    { title: "E-commerce", description: "A e-commerce platform offering a wide variety of gaming PCs, accessories, and other. Tech Stack : MERN STACK", link: "https://github.com/shivateja26/ecommerce_project" },
